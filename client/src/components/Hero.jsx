...
const Hero = () => {
    ...
    return (
        <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center gap-20 p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
            ...
            <img src={assets.main_car} alt="car-main" className='max-h-74' />
        </div>
    )
}
