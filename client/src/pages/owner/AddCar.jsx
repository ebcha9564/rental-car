            ...
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <input type="number" placeholder='120' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay} onChange={e => setCar({ ...car, pricePerDay: e.target.value })} />
                    </div>
                    <div className='flex flex-col w-full'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <select onChange={e => setCar({ ...car, location: e.target.value })} value={car.location} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
                        ...
                        <option value="Lost Angeles">Lost Angeles</option>
